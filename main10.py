...
class TeammateManager:
    ...
    def _teammate_loop(self, name: str, role: str, prompt: str):
        ...
        if member:
            ...
            self._save_config()
            subagent_logger.info(f"Teammate '{name}' set to {member['status']}")
    ...
    def _exec(self, sender: str, tool_name: str, args: dict) -> str:
        ...
        if tool_name == "shutdown_response":
            ...
            subagent_logger.info(f"Teammate '{sender}' shutdown {('approved' if approve else 'rejected')} (req: {req_id})")
        ...
        if tool_name == "plan_approval":
            ...
            subagent_logger.info(f"Teammate '{sender}' submitted plan for approval (req: {req_id})")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            query = input(f"{Colors.CYAN}s10 >> {Colors.RESET}")
